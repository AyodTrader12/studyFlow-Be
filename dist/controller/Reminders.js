...
router.get("/", Auth_1.protect, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const reminders = yield Reminder_1.default.find({ userId: req.user._id }).sort({ date: 1, time: 1 });
        res.json({ reminders });
    }
    catch (_a) {
...
router.post("/", Auth_1.protect, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const reminder = yield Reminder_1.default.create({ userId: req.user._id, text, date, time: time !== null && time !== void 0 ? time : "08:00" });
...
router.delete("/:id", Auth_1.protect, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const reminder = yield Reminder_1.default.findOneAndDelete({ _id: req.params.id, userId: req.user._id });
        if (!reminder) {
