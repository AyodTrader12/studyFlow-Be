...
router.get("/", Auth_1.protect, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const resources = yield Resource_1.default.find(filter).sort({ createdAt: -1 }).skip(skip).limit(parseInt(limit)).select("-content");
...
router.post("/", Auth_1.protect, isAdmin_1.isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (data.type === "youtube" && data.url) {
            try {
                const ytData = yield (0, YoutubeService_1.fetchYouTubeMetadata)(data.url);
                if (!data.title)
        ...
        const resource = yield Resource_1.default.create(Object.assign(Object.assign({}, data), { addedBy: req.user.firebaseUid }));
...
router.patch("/:id", Auth_1.protect, isAdmin_1.isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const resource = yield Resource_1.default.findByIdAndUpdate(req.params.id, req.body, { new: true });
        if (!resource) {
            res.status(404).json({ message: "Resource not found." });
            return;
        }
...
router.delete("/:id", Auth_1.protect, isAdmin_1.isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield Resource_1.default.findByIdAndDelete(req.params.id);
